...
\textbf{Interpretation.} Reducing UPF intake could generate substantial health and economic gains in Argentina. Environmental co-benefits are plausible but depend on the foods that replace UPFs, underscoring the need for integrated policies that pair UPF reduction with guidance towards lower-impact substitutions. \\
...
Yet the consequences of UPF consumption extend well beyond individual health. Food systems are already the single largest driver of environmental degradation globally, accounting for 26\% of anthropogenic greenhouse gas emissions, 32\% of global terrestrial acidification, 66\% of freshwater withdrawals, and 78\% of marine and freshwater eutrophication.\cite{Poore2018,Crippa2021NatureFood} Within this broader footprint, UPFs occupy a disproportionate share. In France, for instance, UPFs represented 19\% of the diet but contributed 24\% to diet-related greenhouse gas emissions, 23\% to water and land use, and 26\% to energy demand.\cite{KesseGuyot2023} A systematic review of 52 studies found that UPFs accounted for up to one-third of total diet-related greenhouse gas emissions, land use and food waste, and up to one-quarter of total diet-related water use among adults in a range of high-income countries.\cite{Anastasiou2022} However, the environmental consequences of reducing UPFs are not straightforward. UPFs often involve additional processing, packaging and long supply chains,\citep{Seferidi2020} yet substitution patterns matter. Replacing UPFs with less processed foods may increase impacts in some domains (e.g., water use) depending on the foods that expand in the diet.\citep{Anastasiou2022JCP,Garzillo2022RSP,Arrieta2022SustainSci} Integrated assessments that jointly consider health gains and environmental trade-offs are therefore needed to avoid unintended consequences.

UPF availability has expanded rapidly worldwide, particularly in middle-income countries.\cite{PAHO2015,Cediel2021} This pattern raises concerns about both the health and economic burden of UPF exposure---historical WHO estimates indicate that direct diabetes costs have ranged from 2.5\% to 15\% of annual health-care budgets in some settings\cite{WHO2003DiabetesCosts}---and about each country's environmental trajectory, given the scale of diet-related resource use.

Comparative risk assessment (CRA) models have been used to estimate mortality attributable to UPF consumption and avertable deaths under reduction targets in Brazil\citep{Nilson2023} and, more recently, across multiple countries.\citep{Nilson2025} However, prior applications have focused on health outcomes and have not examined how the environmental consequences of reducing UPFs depend on the foods that replace them. This omission matters because substitution patterns can reduce greenhouse gas emissions and land use while increasing water use, depending on dietary composition.\cite{Anastasiou2022,Garzillo2022RSP,Arrieta2022SustainSci} The question is particularly relevant in Argentina, where UPFs contribute substantially to dietary energy,\citep{Zapata2023} front-of-package warning legislation is already in force (Argentina Law 27,642),\citep{ArgentinaLaw27642} and no national burden estimate has integrated health, economic, and environmental dimensions.

We therefore developed a national CRA macrosimulation using ENNyS~2 dietary data and official mortality statistics to estimate premature all-cause mortality attributable to UPF consumption among Argentine adults aged 30--69 years, together with years of life lost, gains in life expectancy, and indirect economic costs. We then evaluated policy-relevant UPF-reduction scenarios, including targets aligned with the National Dietary Guidelines food-group structure,\citep{NDG2016} and quantified associated changes in greenhouse gas emissions, land use, water use, and freshwater eutrophication under no-substitution and structured substitution designs. This integrated approach is intended to inform policies that reduce UPF consumption while accounting for substitution-dependent environmental co-benefits and trade-offs.
...
All-cause deaths in 2019 were obtained from Argentina's Directorate of Health Statistics and Information (DEIS)\cite{DEIS2019} and tabulated by sex and the same eight age groups.
...
In the guideline-aligned scenarios, results are interpreted as avertable deaths under feasible implementation rather than as the full attributable burden.
...
\end{equation}
%
where $P$ and $P^{\text{cf}}$ are the baseline and counterfactual exposure distributions, respectively. Because exposure is bounded, integrations were performed on the support $[0,100]$ using a truncated (renormalised) log-normal density and a fine discretisation grid. Attributable (or avertable) deaths were computed as $D_{\text{att}} = \text{PAF} \times D$, where $D$ is the observed number of deaths in the stratum.
...
\begin{itemize}
    ...
    \item \textbf{Isoweight substitution (sensitivity).} Removed UPF mass (kg) was replaced one-for-one with non-UPF foods, using basket-specific environmental intensities per kg. This structural sensitivity is detailed in the Online Appendix, and supplementary scenario tables report the basket-specific environmental results.
\end{itemize}
...
\vspace{0.8em}
\textbf{Table 1.} Contribution of Ultraprocessed Foods to Total Energy Intake in Argentine Adults Aged 30--69 Years by Sex and Age Group (ENNyS 2, 2018--2019)
...
\end{longtable}
\tabnote{Values are survey-weighted mean percentages of total dietary energy from UPFs by sex, age group, and overall total. CI denotes confidence interval and UPFs denotes ultra-processed foods.}
}
...
\par\vspace{0.8em}
\textbf{Table 2.} Deaths From All Causes, PAF, and Estimated Deaths Attributable to the Consumption of Ultraprocessed Foods in Argentine Adults Aged 30--69 Years (2019)
...
\vspace{0.8em}
\textbf{Table 3.} All-cause YLL, life expectancy, and economic outcomes (Argentina, 2019)
...
\vspace{0.8em}
\textbf{Table 4.} Health and economic gains under counterfactual UPF-reduction scenarios, total population (Argentina, 2019)
...
Regarding environmental impacts, reductions in UPF intake generally lowered greenhouse gas emissions and land use in our no-substitution and structured substitution scenarios, but water-use outcomes were more sensitive to what foods replaced UPFs. Under isocaloric substitution, we observed a potential increase in water use, underscoring that healthier replacements are not automatically lower-impact across all environmental dimensions. Similar functional-unit sensitivities have been reported in European cohort analyses, where higher UPF intake was associated with lower impacts per gram but higher impacts per kilocalorie.\cite{Berden2025EPIC} Studies in Brazil also show that higher UPF contribution can be associated with higher dietary carbon and water footprints, particularly for water.\cite{Garzillo2022RSP} This heterogeneity highlights the need to evaluate both nutritional quality and multiple environmental indicators when designing substitution-based interventions, and to consider local production systems and water scarcity contexts.\cite{Anastasiou2022JCP}

This study has several strengths, including the use of the most recent national dietary survey (ENNyS~2), official mortality statistics, and a transparent CRA framework extended to years of life lost, life expectancy, and indirect economic costs. We also modelled alternative UPF-reduction scenarios aligned with national dietary guidelines and evaluated environmental trade-offs under multiple substitution structures. Limitations include: (i) ENNyS~2 represents urban localities, and dietary intake is based on 24-hour recall, which may misclassify usual UPF exposure; (ii) relative risks were largely derived from cohort studies in other settings and may not fully capture Argentina-specific confounding structures or effect modification; (iii) CRA assumes immediate or short-term risk changes after dietary shifts and does not explicitly model latency for chronic disease outcomes; (iv) substitution scenarios necessarily simplify complex behavioural and market responses; (v) environmental coefficients were drawn from international life-cycle assessment sources, and we did not propagate their uncertainty in our probabilistic analysis;\cite{PooreNemecek2018,ADEMEAgribalyse2026} and (vi) the environmental module assumes that dietary-demand shifts are met by domestic production and does not explicitly model imports. This simplification is likely to have limited influence at the aggregate level in Argentina, where Food Balance Sheets indicate a low imported share of total food-energy availability (roughly 1--2\% in recent years), but import composition could still matter for specific food groups.\cite{FAOSTATFBS2026}

Overall, this study extends UPF burden assessment beyond mortality alone by linking avoidable deaths and economic gains to substitution-dependent environmental trade-offs in Argentina. Future work should prioritise Argentina-specific evidence on UPF consumption patterns, causal pathways, and substitution behaviours, alongside locally calibrated environmental footprint coefficients. Integrating distributional analyses (e.g., by income or region) and dynamic modelling of lagged health effects could further strengthen policy relevance.
